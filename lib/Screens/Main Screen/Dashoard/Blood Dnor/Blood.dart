...
class BloodDonor extends StatefulWidget {
  final String blood;
  const BloodDonor({super.key, required this.blood});
...
class _BloodDonorState extends State<BloodDonor> {
                  ...
                  child: Stack(
                    children: [
                      Padding(
                        ...
                        child: CircleAvatar(
                            radius: 36,
                            backgroundImage: NetworkImage(taker.imageURL)),
                      ),
                      Padding(
  ...
  Future<void> getTakerData(String blood) async {
    try {
