              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Spacer(),
                    Text(
                      "$hours hour $minutes mintutes $seconds sec ",
                      style: TextStyle(
                          fontSize: 14,
                          color: Colors.black,
                          fontWeight: FontWeight.normal),
  ...
  Future<void> updateAcceptDonationData() async {
    try {
      ...
      DocumentSnapshot documentSnapshot = await FirebaseFirestore.instance
          .collection('taker')
          .doc(widget.takerid) // Fetch by document ID
          .get();
      ...
      if (documentSnapshot.exists) {
        ...
        await FirebaseFirestore.instance
            .collection('taker')
            .doc(widget.takerid) // Use the same ID to update the document
            .update({
          'rating': rrr,
          'review': review.text,
          'status': true,
        ...
        print('User not found with the given document ID.');
      }
    } catch (e) {
      print('Error: $e');
    }
